 ...
 *
 * Phase 4 lays out: memory · patterns · sessions · sources. They're all
...
const TABS = [
  ...
  { to: "/dashboard/memory", end: false, label: "memory" },
...
export function DashboardNav() {
  return (
    <nav
      ...
      className="border-b border-ink-line mb-12 -mx-6 sm:-mx-10 px-6 sm:px-10"
    >
